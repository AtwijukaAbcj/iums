...
/* footer.twig.html */
class __TwigTemplate_a126c970d2a47443ac18eb381d8cbc5d extends Template
{
    private $source;
    private $macros = [];
...
<span class=\"inline-block font-bold\">
    ";
        ...
        echo "-800\" target='_blank' href='https://su.ac.ug'>Gibbon</a> ";
...
<span class=\"text-xs\">
    ...
    <a class=\"text-";
        // line 34
        echo twig_escape_filter($this->env, ($context["themeColour"] ?? null), "html", null, true);
        echo "-800\" target='_blank' href='https://su.ac.ug/about/#ourTeam'>";
...
Founded by Ross Parker at ICHK Secondary. Built by Ross Parker, Sandra Kuipers and the Gibbon community (https://su.ac.ug/about/)
...
<span class=\"inline-block font-bold\">
    {{ __('Powered by') }} <a class=\"text-{{ themeColour }}-800\" target='_blank' href='https://su.ac.ug'>Seeta University</a> {{ versionName }}<br/>
</span> 
<br/>
<span class=\"text-xs\">
    {{ __('Founded by Ross Parker at ICHK Secondary') }} | {{ __('Built by Ross Parker, Sandra Kuipers and the Gibbon community') }}<br/>
    Copyright © <a class=\"text-{{ themeColour }}-800\" target='_blank' href='http://su.ac.ug'>Seeta University</a> 2010-{{ 'now'|date('Y') }} | Seeta University. (UG)<br/>
    {{ __('Created under the') }} <a class=\"text-{{ themeColour }}-800\" target='_blank' href='#'>SU</a> |
    <a class=\"text-{{ themeColour }}-800\" target='_blank' href='https://su.ac.ug/about/#ourTeam'>{{ __('Credits') }}</a> | 
    <a class=\"text-{{ themeColour }}-800\" target='_blank' href='https://su.ac.ug/about/#translators'>{{ __('Translators') }}</a> | 
    <a class=\"text-{{ themeColour }}-800\" target='_blank' href='https://su.ac.ug/support/'>{{ __('Support') }}</a>
    <br/>
    {{ footerThemeAuthor }}<br/>
</span>
", "footer.twig.html", "C:\\xampp\\htdocs\\iums\\resources\\templates\\footer.twig.html");
    }
}
